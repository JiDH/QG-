 ...
 **************************************************************/
//循环队列结构//泛型：不知道队列的类型或者想改变队列的类型时使用。
...
int datatype[MAXQUEUE]; //存储进队列的数据形式
/**************************************************************
...
/**
 *  @name        : Status TraverseAQueue(const AQueue *Q, void (*foo)(void *q,int i))
 *    @description : 遍历函数操作
